...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\timage_url\x18\x04 \x01(\tR\bimageUrl2y\n" +
	"\aSortify\x12?\n" +
	"\n" +
	"AuthByCode\x12\x17.auth.AuthByCodeRequest\x1a\x18.auth.AuthByCodeResponse\x12-\n" +
	"\x04User\x12\x11.auth.UserRequest\x1a\x12.auth.UserResponseB\fZ\n" +
...
var file_sso_sso_proto_goTypes = []any{
	(*AuthByCodeRequest)(nil),  // 0: auth.AuthByCodeRequest
	(*AuthByCodeResponse)(nil), // 1: auth.AuthByCodeResponse
	(*UserRequest)(nil),        // 2: auth.UserRequest
	(*UserResponse)(nil),       // 3: auth.UserResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Sortify.AuthByCode:input_type -> auth.AuthByCodeRequest
	2, // 1: auth.Sortify.User:input_type -> auth.UserRequest
	1, // 2: auth.Sortify.AuthByCode:output_type -> auth.AuthByCodeResponse
	3, // 3: auth.Sortify.User:output_type -> auth.UserResponse
