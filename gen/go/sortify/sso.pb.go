...
func (x *AuthByCodeRequest) Reset() {
	*x = AuthByCodeRequest{}
	mi := &file_sortify_sso_proto_msgTypes[0]
...
func (*AuthByCodeRequest) Descriptor() ([]byte, []int) {
	return file_sortify_sso_proto_rawDescGZIP(), []int{0}
}
...
func (x *AuthByCodeResponse) Reset() {
	*x = AuthByCodeResponse{}
	mi := &file_sortify_sso_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AuthByCodeResponse) Descriptor() ([]byte, []int) {
	return file_sortify_sso_proto_rawDescGZIP(), []int{1}
}
...
func (x *UserRequest) Reset() {
	*x = UserRequest{}
	mi := &file_sortify_sso_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserRequest) Descriptor() ([]byte, []int) {
	return file_sortify_sso_proto_rawDescGZIP(), []int{2}
}
...
func (x *UserResponse) Reset() {
	*x = UserResponse{}
	mi := &file_sortify_sso_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserResponse) Descriptor() ([]byte, []int) {
	return file_sortify_sso_proto_rawDescGZIP(), []int{3}
}
...
var File_sortify_sso_proto protoreflect.FileDescriptor

const file_sortify_sso_proto_rawDesc = "" +
	"\n" +
	"\x11sortify/sso.proto\x12\asortify\"=\n" +
...
var (
	file_sortify_sso_proto_rawDescOnce sync.Once
	file_sortify_sso_proto_rawDescData []byte
)

func file_sortify_sso_proto_rawDescGZIP() []byte {
	file_sortify_sso_proto_rawDescOnce.Do(func() {
		file_sortify_sso_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sortify_sso_proto_rawDesc), len(file_sortify_sso_proto_rawDesc)))
	})
	return file_sortify_sso_proto_rawDescData
}

var file_sortify_sso_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_sortify_sso_proto_goTypes = []any{
...
var file_sortify_sso_proto_depIdxs = []int32{
...
func init() { file_sortify_sso_proto_init() }
func file_sortify_sso_proto_init() {
	if File_sortify_sso_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sortify_sso_proto_rawDesc), len(file_sortify_sso_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_sortify_sso_proto_goTypes,
		DependencyIndexes: file_sortify_sso_proto_depIdxs,
		MessageInfos:      file_sortify_sso_proto_msgTypes,
	}.Build()
	File_sortify_sso_proto = out.File
	file_sortify_sso_proto_goTypes = nil
	file_sortify_sso_proto_depIdxs = nil
}
